...
export const INCIDENTS: IncidentSummary[] = [
  {
    ...
    loss_usd: 1_081_600,
    loss_label: "$1.08M+ extracted",
    chains: ["Solana"],
    attack_vector: "Authorization-layer takeover: add admin, then withdraw",
    attribution: "Unknown operator; collector FVNF...nCEj",
    short_summary:
      "An operator used Avici's signature path to add a new collateral-account admin and drain at least 125 sending accounts. Proceeds peaked near $1.08M, were swapped into SOL, swept through fresh relays, and began exiting through deBridge orders.",
    status: "ongoing",
    tags: ["Solana", "Avici", "USDC", "USDT", "authorization", "Jupiter", "deBridge"],
  },
  {
