...
export const INCIDENTS: IncidentSummary[] = [
  {
    ...
    loss_label: "~$387.5M revised / 8+ networks",
    chains: ["Ethereum", "Arbitrum", "Base", "Optimism", "BSC", "Avalanche", "XRP Ledger", "Zcash", "TRON"],
    attack_vector: "Backend transaction-data spoofing + valid withdrawal signatures",
    attribution: "Unknown; four primary recipient addresses published by Bitget",
    short_summary:
      "An attacker compromised a backend system inside Bitget's wallet infrastructure and spoofed transaction data, causing valid signatures for unauthorized transfers from hot and warm wallets across eight chains. Bitget later revised the affected-asset accounting to approximately $387.5M after adding Zcash and TRON assets; it says the incident is contained and recovery tracing continues.",
    status: "ongoing",
    tags: ["Bitget", "exchange", "hot-wallet", "backend-compromise", "multi-chain", "Blockaid", "recovery", "live-tracking"],
  },
  {
  ...
  },
  {
    ...
    loss_usd: 500_859.22,
    loss_label: "$500.86K confirmed / $1.02M campaign",
    chains: ["Solana"],
    attack_vector: "Vulnerable outdated Rain Solana card contract",
    attribution: "Unknown operator; collector FVNF...nCEj",
    short_summary:
      "Rain confirmed an outdated Solana card-contract vulnerability. Avici reconciled $500,859.22 across 1,685 card-balance users and promised full refunds; the broader cross-program proceeds were reported near $1.02M and routed toward Ethereum.",
    status: "ongoing",
    tags: ["Solana", "Avici", "Rain", "Tria", "card-contract", "refund", "deBridge", "Tornado-Cash"],
  },
  {
